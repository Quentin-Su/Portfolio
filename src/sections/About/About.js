...
import Person from '../../utils/assets/Quentin_Person.png';
...
export const About = () => {
    ...
    return (
        <>
            <motion.div ref={ref} className='about_person_container' variants={staggerContainer} initial='hidden' animate={isInView ? 'show' : 'hidden'} exit='hidden'>
                <motion.img src={Person} alt='Quentin | Me' variants={imageVariants} />
                <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
                    <motion.path d="M81,57.5Q71,65,67.5,79Q64,93,49.5,94.5Q35,96,29.5,82.5Q24,69,23.5,59.5Q23,50,24.5,41Q26,32,33,26Q40,20,51,16.5Q62,13,70,21.5Q78,30,84.5,40Q91,50,81,57.5Z" variants={blob}></motion.path>
                </svg>
            </motion.div>

            <motion.div ref={ref} className='about_me_container' variants={fadeIn('left', 'tween', .2, .6)} initial='hidden' animate={isInView ? 'show' : 'hidden'} exit='hidden'>
                <div className='about_me_content'>
                    ...
                    <div className='about_me_links'>
                        <span>See more</span>
                        <Link className='about_me_link link_hover_animation' to='https://github.com/Quentin-Su/' rel='noreferrer' target='_blank' aria-label='My GitHub profile'>
                        ...
                        <Link className='about_me_link link_hover_animation' to='https://www.linkedin.com/in/quentin-sussetto-882876238/' rel='noreferrer' target='_blank' aria-label='My Linkedin profile'>
