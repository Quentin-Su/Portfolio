            ...
            <div className='about_me_container'>
                <div className='about_me_content'>
                    ...
                    <div className='about_me_links'>
                        <span>See more</span>
                        <Link className='about_me_link' to='https://github.com/Quentin-Su/' target='_blank' aria-label='My GitHub profile'>
                        ...
                        <Link className='about_me_link' to='https://www.linkedin.com/in/quentin-sussetto-882876238/' target='_blank' aria-label='My Linkedin profile'>
